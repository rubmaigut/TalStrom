...
export async function addFavorite(currentUserSub: string, favoriteSub: string) {
  const url = `${API_BASE_URL}/Users/favorite/toggle?userSub=${currentUserSub}&favoriteSub=${favoriteSub}}`;
